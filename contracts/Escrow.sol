...
contract Escrow {
    ...
    function finalizeSale() public {
        ...
        require(success);
        // [call{value: address(this).balance}("")] means that we are calling the external function
        // of seller account, to transfer the contract's balance.
        // in short bole to "call{value: address(this).balance}("")" ka matlab hi hota h transfer ether/value
        // to sellers account, rat lo!
    ...
    receive() external payable {} // without this depositEarnest function will not work.
